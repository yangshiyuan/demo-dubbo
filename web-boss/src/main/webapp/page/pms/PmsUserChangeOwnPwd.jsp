...
<div class="pageContent">
    <form id="form" method="post" action="pms_userChangeOwnPwd.action" class="pageForm required-validate"
        ...
        <div class="pageFormContent" layoutH="60">
            ...
            <div class="unit">
                <label>确认新密码：</label>
                <input type="password" name="newPwd2" equalTo="#newPwd" class="required" minlength="6" maxlength="20"
                       size="30"/>
            </div>
            <div class="unit">
            </div>
