    ...
    <div class="panelBar">
        <ul class="toolBar">
            <rc:permission value="pms:user:add">
                <li><a class="add" href="pms_addPmsUserUI.action" target="dialog" rel="input"
                       title="添加用户"><span>添加用户</span></a></li>
            </rc:permission>
        </ul>
    </div>
        ...
        <s:iterator value="recordList" status="st">
            ...
            <c:if test="${(type eq UserTypeEnum.ADMIN.value && type eq UserTypeEnum.ADMIN.value) || (type eq UserTypeEnum.USER.value)}">
                <tr target="sid_user" rel="${id}">
                    ...
                    <td>
                        [<a href="pms_viewPmsUserUI.action?id=${id}" title="查看【${userNo }】详情" target="dialog"
